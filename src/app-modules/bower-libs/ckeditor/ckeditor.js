...
(function () {
    ...
    window.CKEDITOR || (window.CKEDITOR = function () {
        var a = /(^|.*[\\\/])ckeditor\.js(?:\?.*|;.*)?$/i, d = {
            timestamp: "H5SC", version: "4.7.1", revision: "08ffd39", rnd: Math.floor(900 * Math.random()) + 100, _: {pending: [], basePathSrcPattern: a}, status: "unloaded", basePath: function () {
    ...
    CKEDITOR.event || (CKEDITOR.event = function () {
        ...
        return {
            define: function (b, d) {
                ...
                function n(a, f, C, k) {
                    a = {name: b, sender: this, editor: a, data: f, listenerData: h, stop: C, cancel: k, removeListener: q};
            ...
            once: function () {
                ...
                return function (k, n, q) {
                    ...
                    if (f) {
                        var w = f.listeners;
                        if (w.length) for (var w = w.slice(0), A, E = 0; E < w.length; E++) {
                            if (f.errorProof) try {
                                A =
    ...
    CKEDITOR.dom = {};
    (function () {
        var a = [], d = CKEDITOR.env.gecko ? "-moz-" : CKEDITOR.env.webkit ? "-webkit-" : CKEDITOR.env.ie ? "-ms-" : "", b = /&/g, c = />/g, e = /</g, g = /"/g, h = /&(lt|gt|amp|quot|nbsp|shy|#\d{1,5});/g, k = {lt: "\x3c", gt: "\x3e", amp: "\x26", quot: '"', nbsp: " ", shy: "­"},
            n = function (a, f) {
        ...
        CKEDITOR.tools = {
            ...
            transformPlainTextToHtml: function (a, f) {
                ...
                if (!b) {
                    var d = /\n{2}/g;
                    if (d.test(c)) var n = "\x3c" + k + "\x3e", m = "\x3c/" + k + "\x3e", c = n + c.replace(d, function () {
                        return m + n
                    }) + m
                }
                c = c.replace(/\n/g, "\x3cbr\x3e");
    ...
    CKEDITOR.dtd = function () {
        var a = CKEDITOR.tools.extend, d = function (a, b) {
                ...
                return c
            }, b = {}, c = {}, e = {address: 1, article: 1, aside: 1, blockquote: 1, details: 1, div: 1, dl: 1, fieldset: 1, figure: 1, footer: 1, form: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, header: 1, hgroup: 1, hr: 1, main: 1, menu: 1, nav: 1, ol: 1, p: 1, pre: 1, section: 1, table: 1, ul: 1},
            g = {command: 1, link: 1, meta: 1, noscript: 1, script: 1, style: 1}, h = {}, k = {"#": 1}, n = {center: 1, dir: 1, noframes: 1};
        a(b, {
            a: 1,
            abbr: 1,
            area: 1,
        ...
        CKEDITOR.tools.extend(CKEDITOR.dom.element.prototype, {
            ...
            is: function () {
                ...
                if (document.documentElement.getBoundingClientRect && (CKEDITOR.env.ie ?
                    ...
                    var e = this.$.getBoundingClientRect(), g = f.$.documentElement, x = g.clientTop || d.$.clientTop || 0, m = g.clientLeft || d.$.clientLeft || 0, h = !0;
                ...
                w = a.getWindow();
                d = x(this, w);
                var y = x(a, w), H = this.$.offsetHeight;
                f = this.$.offsetWidth;
                var l = a.$.clientHeight, u = a.$.clientWidth;
    ...
    (function () {
        function a(a, b) {
            ...
            f = c.endContainer;
            var e = c.startOffset, C = c.endOffset, g, l = this.guard, u = this.type, I = a ? "getPreviousSourceNode" : "getNextSourceNode";
            if (!a && !this._.guardLTR) {
                var J = f.type == CKEDITOR.NODE_ELEMENT ? f : f.getParent(), h = f.type == CKEDITOR.NODE_ELEMENT ? f.getChild(C) : f.getNext();
            ...
            if (a && !this._.guardRTL) {
                var r = d.type == CKEDITOR.NODE_ELEMENT ? d : d.getParent(), z = d.type == CKEDITOR.NODE_ELEMENT ? e ? d.getChild(e - 1) : null : d.getPrevious();
                this._.guardRTL = function (a, b) {
                    return (!b || !r.equals(a)) && (!z || !a.equals(z)) && (a.type != CKEDITOR.NODE_ELEMENT || !b || !a.equals(c.root))
                }
            }
        ...
        var e = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, g = CKEDITOR.dom.walker.whitespaces(), h = CKEDITOR.dom.walker.bookmark(), k = CKEDITOR.dom.walker.temp(), n = function (a) {
        ...
        var f = CKEDITOR.dom.walker.empty(), C = CKEDITOR.dom.walker.validEmptyBlockContainers = CKEDITOR.tools.extend(function (a) {
            var b = {}, c;
    ...
    (function () {
        ...
        function d(a, b, c, d, e) {
            ...
            a.optimizeBookmark();
            var k = 0 === b, q = 1 == b, l = 2 == b;
            b = l || q;
            var u = a.startContainer, I = a.endContainer,
                J = a.startOffset, D = a.endOffset, r, z, v, B, L, n;
            if (l && I.type == CKEDITOR.NODE_TEXT && u.equals(I)) u = a.document.createText(u.substring(J, D)), c.append(u); else {
                ...
                for (var O = u.getParents(), p = I.getParents(), F = m(), t = O.length - 1, G = p.length - 1, N = c, Z, X, U, ea = -1, P = F; P <= t; P++) {
                    X =
                        O[P];
                    U = X.getNext();
                    for (P != t || X.equals(p[P]) && t < G ? b && (Z = N.append(X.clone(0, e))) : r ? g(X, N, !1, v) : L && N.append(a.document.createText(X.substring(J))); U;) {
                        if (U.equals(p[P])) {
                            ea = P;
                            break
                        }
                ...
                N = c;
                for (P = F; P <= G; P++) if (c = p[P], U = c.getPrevious(), c.equals(O[P])) b && (N = N.getChild(0)); else {
        ...
        var g = {abbr: 1, acronym: 1, b: 1, bdo: 1, big: 1, cite: 1, code: 1, del: 1, dfn: 1, em: 1, font: 1, i: 1, ins: 1, label: 1, kbd: 1, q: 1, samp: 1, small: 1, span: 1, strike: 1, strong: 1, sub: 1, sup: 1, tt: 1, u: 1, "var": 1}, h = CKEDITOR.dom.walker.bogus(),
            k = /^[\t\r\n ]*(?:&nbsp;|\xa0)$/, n = CKEDITOR.dom.walker.editable(), q = CKEDITOR.dom.walker.ignored(!0);
        CKEDITOR.dom.range.prototype = {
            clone: function () {
                ...
                return function (c) {
                    var d = this.collapsed, e = {container: this.startContainer, offset: this.startOffset}, m = {container: this.endContainer, offset: this.endOffset};
                ...
                switch (a) {
                    ...
                    case CKEDITOR.ENLARGE_ELEMENT:
                        ...
                        var m = this.getCommonAncestor(), h = this.root, k, q, l, u, I, J = !1, D, r;
                        ...
                        for (l = c(l); l || u;) {
                            ...
                            for (; u;) if (D = !1, u.type == CKEDITOR.NODE_COMMENT) u = u.getPrevious(); else {
                                if (u.type == CKEDITOR.NODE_TEXT) r = u.getText(), d.test(r) && (u = null), D = /[\s\ufeff]$/.test(r); else if ((u.$.offsetWidth > (CKEDITOR.env.webkit ? 1 : 0) || b && u.is("br")) && !u.data("cke-bookmark")) if (J && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
                                    r = u.getText();
                                    if (d.test(r)) u = null; else for (var z = u.$.getElementsByTagName("*"), v = 0, B; B =
                                        z[v++];) if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
                                        u = null;
                                        break
                                    }
                                    u && (D = !!r.length)
                        ...
                        for (; l ||
                            ...
                            for (; u;) {
                                D = !1;
                                if (u.type == CKEDITOR.NODE_TEXT) r = u.getText(), g(u, 0) || (u = null), D = /^[\s\ufeff]/.test(r); else if (u.type == CKEDITOR.NODE_ELEMENT) {
                                    if ((0 < u.$.offsetWidth || b && u.is("br")) && !u.data("cke-bookmark")) if (J && CKEDITOR.dtd.$removeEmpty[u.getName()]) {
                                        r = u.getText();
                                        if (d.test(r)) u = null; else for (z = u.$.getElementsByTagName("*"), v =
                                            0; B = z[v++];) if (!CKEDITOR.dtd.$removeEmpty[B.nodeName.toLowerCase()]) {
                                            u = null;
                                            break
                                        }
                                        u && (D = !!r.length)
                    ...
                    case CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS:
                        ...
                        var L, n, O = CKEDITOR.dom.walker.blockBoundary(a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS ? {br: 1} : null), p = null, F = function (a) {
                        ...
                        if (a == CKEDITOR.ENLARGE_LIST_ITEM_CONTENTS) {
                            l = this.clone();
                            l = new CKEDITOR.dom.walker(l);
                            var t = CKEDITOR.dom.walker.whitespaces(), G = CKEDITOR.dom.walker.bookmark();
                ...
                var d = "boolean" === typeof c ? c : c && "boolean" === typeof c.shrinkOnBlockBoundary ? c.shrinkOnBlockBoundary : !0, e = c && c.skipBogus;
                if (!this.collapsed) {
                    a = a || CKEDITOR.SHRINK_TEXT;
                    var g = this.clone(), m = this.startContainer, h = this.endContainer, k = this.startOffset, q = this.endOffset, l = c = 1;
                    ...
                    var g = new CKEDITOR.dom.walker(g), u = CKEDITOR.dom.walker.bookmark(), I = CKEDITOR.dom.walker.bogus();
            ...
            setStart: function (b, c) {
                ...
                var c = new CKEDITOR.dom.elementPath(this.startContainer, this.root), d = new CKEDITOR.dom.elementPath(this.endContainer, this.root), e = c.block, g = d.block, m = null;
            ...
            moveToElementEditEnd: function (a) {
                ...
                var b = this.startContainer, c = this.endContainer, d = b.getAscendant("table", !0), e = c.getAscendant("table", !0);
                ...
                var c = this.getCommonAncestor(), d = this.getBoundaryNodes(), e = [], g, m, h, k;
                if (c && c.find) for (m = c.find(a), g = 0; g < m.count(); g++) if (c = m.getItem(g), b || !c.isReadOnly()) h = c.getPosition(d.startNode) & CKEDITOR.POSITION_FOLLOWING || d.startNode.equals(c), k = c.getPosition(d.endNode) & CKEDITOR.POSITION_PRECEDING + CKEDITOR.POSITION_IS_CONTAINED ||
        ...
        a.prototype = {
            getNextParagraph: function (a) {
                ...
                if (!this._.started) {
                    ...
                    h = x.startPath();
                    var m = x.endPath(), K = !x.collapsed && c(x, h.block), y = !x.collapsed && c(x, m.block, 1);
                ...
                for (this._.nextNode = null; m;) {
                    var K = 0, y = m.hasAscendant("pre"), H = m.type != CKEDITOR.NODE_ELEMENT, l = 0;
                    if (H) m.type == CKEDITOR.NODE_TEXT && e.test(m.getText()) && (H = 0); else {
                        var u = m.getName();
                        if (CKEDITOR.dtd.$block[u] && "false" == m.getAttribute("contenteditable")) {
                            ...
                            if ("br" == u) H = 1; else if (!h && !m.getChildCount() && "hr" != u) {
                                d = m;
                                w = m.equals(x);
                                break
                            }
    ...
    (function () {
        function a(a, b, c, d, e) {
            ...
            for (l in b) {
                ...
                for (g in V) {
                    t[g] = h(t[g], r) || null;
                    var p = t, u = O[g], m = h(t[O[g]], r), G = t[g], z = [], B = !0, F = void 0;
                    m ? B = !1 : m = {};
        ...
        function c(a, b, c) {
            if (!a.match || a.match(b)) {
                ...
                b = b.classes;
                if (a) {
                    for (var d = !1, l = !0 === a, t = b.length; t--;) if (l || a(b[t])) b.splice(t, 1), d = !0;
                    a = d
                } else a = !1;
        ...
        function A(a, b, e, l) {
            ...
            if (l.doCallbacks && a.elementCallbacks) {
                a:{
                    ...
                    for (var v = 0, g = r.length, p; v < g; ++v) if (p = r[v](b)) {
                        r = p;
                        break a
                    }
                    r = void 0
            ...
            if (l.doFilter) {
                a:{
                    ...
                    p = l.skipRequired;
                    var z = {valid: !1, validAttributes: {}, validClasses: {}, validStyles: {}, allAttributes: !1, allClasses: !1, allStyles: !1, hadInvalidAttribute: !1, hadInvalidClass: !1, hadInvalidStyle: !1}, h, B;
                    if (a || r) {
                        w(b);
                        if (v) for (h = 0, B = v.length; h < B; ++h) if (!1 === c(v[h], b, z)) {
                            a = null;
                            break a
                        }
                ...
                var F = a.validStyles;
                r = a.validClasses;
                var v = b.attributes, I = b.styles, g = b.classes;
                p = b.classBackup;
                var J = b.styleBackup, k, N, D = [], z = [], O = /^data-cke-/;
                h = !1;
                delete v.style;
                delete v["class"];
                delete b.classBackup;
                delete b.styleBackup;
                if (!a.allAttributes) for (k in v) B[k] || (O.test(k) ? k == (N = k.replace(/^data-cke-saved-/, "")) || B[N] || (delete v[k], h = !0) : (delete v[k], h = !0));
        ...
        function l(a, b, c) {
            var d = a.name;
            if (z.$empty[d] || !a.children.length) "hr" == d && "br" == b ? a.replaceWith(y()) : (a.parent && c.push({
                check: "it",
                el: a.parent
            }), a.remove()); else if (z.$block[d] || "tr" == d) if ("br" == b) a.previous && !H(a.previous) && (b = y(), b.insertBefore(a)), a.next && !H(a.next) && (b = y(), b.insertAfter(a)), a.replaceWithChildren(); else {
                var d = a.children, e;
                b:{
                    e = z[b];
                    for (var l = 0, t = d.length, f; l < t; ++l) if (f = d[l], f.type == CKEDITOR.NODE_ELEMENT && !e[f.name]) {
                        e = !1;
                        break b
                    }
                    e = !0
                ...
                if (e) a.name = b, a.attributes =
                    ...
                    e = a.parent;
                    for (var l = e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || "body" == e.name, v, r, t = d.length; 0 < t;) f = d[--t], l && (f.type == CKEDITOR.NODE_TEXT || f.type == CKEDITOR.NODE_ELEMENT && z.$inline[f.name]) ? (v || (v = new CKEDITOR.htmlParser.element(b), v.insertAfter(a), c.push({
                        check: "parent-down",
                        el: v
                    })), v.add(f, 0)) : (v = null, r = z[e.name] || z.span, f.insertAfter(a), e.type == CKEDITOR.NODE_DOCUMENT_FRAGMENT || f.type != CKEDITOR.NODE_ELEMENT || r[f.name] || c.push({check: "el-up", el: f}));
                    a.remove()
                }
            } else d in
        ...
        function I(a, b) {
            var c = b.getDefinition(), d = c.attributes, e = c.styles, l, f, t, v;
            if (a.name != c.element) return !1;
            for (l in d) if ("class" == l) for (c = d[l].split(/\s+/), t = a.classes.join("|"); v = c.pop();) {
        ...
        var z = CKEDITOR.dtd, v = CKEDITOR.tools.copy, B = CKEDITOR.tools.trim, L = ["", "p", "br", "div"];
        ...
        CKEDITOR.filter.prototype = {
            allow: function (b, c, d) {
                ...
                var e = this, f = [], t = this.editor && this.editor.config.protectedSource, v, r = !1, g = {doFilter: !c, doTransform: !0, doCallbacks: !0, toHtml: b};
                a.forEach(function (a) {
                    if (a.type == CKEDITOR.NODE_ELEMENT) {
                        if ("off" == a.attributes["data-cke-filter"]) return !1;
                        if (!b || "span" != a.name || !~CKEDITOR.tools.objectKeys(a.attributes).join("|").indexOf("data-cke-")) if (v = A(e, a, f, g), v & 1) r = !0; else if (v & 2) return !1
                        ...
                        a:{
                            ...
                            c = [];
                            var l, p, u;
                            if (t) for (p = 0; p < t.length; ++p) if ((u = d.match(t[p])) && u[0].length == d.length) {
                                c = !0;
                                break a
                            }
                ...
                for (; p = a.pop();) if (c = p.el, c.parent) switch (u = z[c.parent.name] || z.span, p.check) {
                    case "it":
            ...
            addContentForms: function (a) {
                ...
                if (!this.disabled && a) {
                    ...
                    for (e = 0; e < a.length; ++e) {
                        b = a[e];
                        var l = void 0, f = void 0, t = void 0, v = void 0, g = void 0, p = void 0;
                        c = [];
                ...
                var t = CKEDITOR.tools.clone(e), r = [], g;
        ...
        var V = {styles: 1, attributes: 1, classes: 1}, O = {styles: "requiredStyles", attributes: "requiredAttributes", classes: "requiredClasses"}, p = /^([a-z0-9\-*\s]+)((?:\s*\{[!\w\-,\s\*]+\}\s*|\s*\[[!\w\-,\s\*]+\]\s*|\s*\([!\w\-,\s\*]+\)\s*){0,3})(?:;\s*|$)/i,
            F = {styles: /{([^}]+)}/, attrs: /\[([^\]]+)\]/, classes: /\(([^\)]+)\)/}, t = /^cke:(object|embed|param)$/,
        ...
        N = CKEDITOR.filter.transformationsTools = {
            sizeToStyle: function (a) {
                ...
                if ("string" == typeof b) a.name = b; else {
                    var c = b.getDefinition(), d = c.styles, e = c.attributes, l, t, f, v;
                    a.name = c.element;
            ...
            var g = {}, h = function (b) {
                a.call(this, b, function (a) {
                    ...
                    for (f in a) {
                        ...
                        if (!d[f]) {
                            if (k.icons) for (var A = k.icons.split(","), E = A.length; E--;) CKEDITOR.skin.addIcon(A[E], k.path + "icons/" + (CKEDITOR.env.hidpi && k.hidpi ? "hidpi/" : "") + A[E] + ".png");
                            d[f] = 1
                        }
    ...
    (function () {
        ...
        function d() {
            do var a = "editor" + ++E; while (CKEDITOR.instances[a]);
            return a
        }
        ...
        function C(a) {
            var b = a.config, c = b.plugins, d = b.extraPlugins, e =
                b.removePlugins;
            if (d) var f = new RegExp("(?:^|,)(?:" + d.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(f, ""), c = c + ("," + d);
            if (e) var g = new RegExp("(?:^|,)(?:" + e.replace(/\s*,\s*/g, "|") + ")(?\x3d,|$)", "g"), c = c.replace(g, "");
            CKEDITOR.env.air && (c += ",adobeair");
            CKEDITOR.plugins.load(c.split(","), function (c) {
                var d = [], e = [], f = [];
                a.plugins = c;
                for (var l in c) {
                    var u = c[l], h = u.lang, k = null, O = u.requires, p;
        ...
        function A(a, b) {
            ...
            for (var e = new CKEDITOR.dom.documentFragment, f, g, h, k = 0; k < a.length; k++) {
                var r = a[k], z = r.startContainer.getAscendant("tr", !0);
                c(r) ? (f ||
    ...
    CKEDITOR.htmlParser.comment.prototype = CKEDITOR.tools.extend(new CKEDITOR.htmlParser.node, {
        type: CKEDITOR.NODE_COMMENT, filter: function (a, d) {
            var b = this.value;
            ...
            function (g, h, k) {
                function n(a) {
                    ...
                    if (0 < m.length) for (var c = 0; c < m.length; c++) {
                        var d = m[c], e = d.name, f = CKEDITOR.dtd[e], l = y.name && CKEDITOR.dtd[y.name];
                ...
                var E = new CKEDITOR.htmlParser, x = h instanceof CKEDITOR.htmlParser.element ? h : "string" == typeof h ? new CKEDITOR.htmlParser.element(h) : new CKEDITOR.htmlParser.fragment, m = [], K = [], y = x, H = "textarea" == x.name, l = "pre" == x.name;
                    ...
                    if (a(f)) m.push(f); else {
                        ...
                        if ("br" == e) K.push(f); else {
                            for (; !(h = (g = y.name) ? CKEDITOR.dtd[g] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c, f.isUnknown || y.isUnknown || h[e]);) if (y.isOptionalClose) E.onTagClose(g); else if (e in b && g in b) g = y.children, (g = g[g.length - 1]) && "li" == g.name || C(g = new CKEDITOR.htmlParser.element("li"), y), !f.returnPoint && (f.returnPoint = y), y = g; else if (e in CKEDITOR.dtd.$listItem &&
                                !A(e, g)) E.onTagOpen("li" == e ? "ul" : "dl", {}, 0, 1); else if (g in d && !A(e, g)) !f.returnPoint && (f.returnPoint = y), y = y.parent; else if (g in CKEDITOR.dtd.$inline && m.unshift(y), y.parent) C(y, y.parent, 1); else {
                                f.isOrphan = 1;
                                break
                            }
                            n(e);
                ...
                E.onText = function (a) {
                    ...
                    var b = y.name, f = b ? CKEDITOR.dtd[b] || (y._.isBlockLike ? CKEDITOR.dtd.div : CKEDITOR.dtd.span) : c;
                    if (!H && !f["#"] && b in d) E.onTagOpen(e[b] || ""), E.onText(a); else {
                        q();
                        n();
                        l || H || (a = a.replace(/[\t\r\n ]{2,}|[\t\r\n]/g, " "));
    ...
    (function () {
        ...
        a.prototype = {
            add: function (a, c, d) {
                ...
                var d = c instanceof CKEDITOR.htmlParser.node || c instanceof CKEDITOR.htmlParser.fragment, g = Array.prototype.slice.call(arguments, 1), h = this.rules, k = h.length, n, q, f, C;
    ...
    (function () {
        function a(a, d) {
            ...
            function v(a, d) {
                return function (e) {
                    if (e.type != CKEDITOR.NODE_DOCUMENT_FRAGMENT) {
                        var l = [], t = b(e), v, p;
                        if (t) for (r(t, 1) && l.push(t); t;) g(t) && (v = c(t)) && r(v) && ((p = c(v)) && !g(p) ? l.push(v) : (f(z).insertAfter(v), v.remove())), t = t.previous;
            ...
            var p = {elements: {}}, z = "html" == d, B = CKEDITOR.tools.extend({}, l), F;
        ...
        CKEDITOR.htmlDataProcessor = function (b) {
            ...
            b.on("toHtml", function (a) {
                a = a.data;
                var c = a.dataValue, e, c = x(c, b), c = f(c, L), c = q(c), c = f(c, B), c = c.replace(O, "$1cke:$2"), c = c.replace(F, "\x3ccke:$1$2\x3e\x3c/cke:$1\x3e"),
        ...
        var m = /(?:&nbsp;|\xa0)$/, K = "{cke_protected}", y = CKEDITOR.dtd, H = "caption colgroup col thead tfoot tbody".split(" "), l = CKEDITOR.tools.extend({}, y.$blockLimit,
            y.$block), u = {elements: {input: k, textarea: k}}, I = {
        ...
        var r = /<(a|area|img|input|source)\b([^>]*)>/gi, z = /([\w-:]+)\s*=\s*(?:(?:"[^"]*")|(?:'[^']*')|(?:[^ "'>]+))/gi, v = /^(href|src|name)$/i, B = /(?:<style(?=[ >])[^>]*>[\s\S]*?<\/style>)|(?:<(:?link|meta|base)[^>]*>)/gi, L = /(<textarea(?=[ >])[^>]*>)([\s\S]*?)(?:<\/textarea>)/gi,
            V = /<cke:encoded>([^<]*)<\/cke:encoded>/gi, O = /(<\/?)((?:object|embed|param|html|body|head|title)[^>]*>)/gi, p = /(<\/?)cke:((?:html|body|head|title)[^>]*>)/gi, F = /<cke:(param|embed)([^>]*?)\/?>(?!\s*<\/cke:\1)/gi
    })();
    "use strict";
    ...
    (function () {
        ...
        CKEDITOR.inlineAll = function () {
            var a, d, b;
            for (b in CKEDITOR.dtd.$editable) for (var c = CKEDITOR.document.getElementsByTag(b), e = 0, g = c.count(); e < g; e++) a = c.getItem(e), "true" == a.getAttribute("contenteditable") && (d = {element: a, config: {}}, !1 !== CKEDITOR.fire("inline", d) && CKEDITOR.inline(a, d.config))
        };
        CKEDITOR.domReady(function () {
    ...
    (function () {
        ...
        function b(a) {
            var b = a.name, d = a.element, h = a.elementMode, k =
                    a.fire("uiSpace", {space: "top", html: ""}).html, n = a.fire("uiSpace", {space: "bottom", html: ""}).html,
        ...
        CKEDITOR.editor.prototype.resize = function (a, b, d, h) {
            var k = this.container, n = this.ui.space("contents"), q = CKEDITOR.env.webkit && this.document && this.document.getWindow().$.frameElement;
    ...
    (function () {
        function a(a) {
            var b = a.editor, e = a.data.path, f = e.blockLimit, g = a.data.selection, r = g.getRanges()[0], z;
            if (CKEDITOR.env.gecko || CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller) if (g = d(g, e)) g.appendBogus(), z = CKEDITOR.env.ie;
            h(b, e.block, f) && r.collapsed && !r.getCommonAncestor().isReadOnly() && (e = r.clone(), e.enlarge(CKEDITOR.ENLARGE_BLOCK_CONTENTS), f = new CKEDITOR.dom.walker(e), f.guard = function (a) {
            ...
            base: CKEDITOR.dom.element, $: function (a, b) {
                ...
                focus: function () {
                    ...
                    this.attachListener(a, "beforeGetData", function () {
                        var b = this.getData();
                        this.is("textarea") || !1 !== a.config.ignoreEmptyParagraph && (b = b.replace(E, function (a, b) {
                            return b
                        }));
                        a.setData(b, null, 1)
                    }, this);
                    ...
                    if (!this.is("textarea")) {
                        ...
                        if (k) {
                            var h = e.getHead(), r = h.getCustomData("stylesheet");
                        ...
                        this.attachListener(a, "key", function (b) {
                            ...
                            if (0 !== b.getRanges().length) {
                                if (c in
                                    z) {
                                    var e, r = b.getRanges()[0], p = r.startPath(), h, t, k, c = 8 == c;
                        ...
                        a.blockless && CKEDITOR.env.ie && CKEDITOR.env.needsBrFiller && this.attachListener(this, "keyup", function (b) {
                            b.data.getKeystroke() in z && !this.getFirst(c) && (this.appendBogus(), b = a.createRange(), b.moveToPosition(this, CKEDITOR.POSITION_AFTER_START), b.select())
                        });
        ...
        x = function () {
            ...
            function b(c, d) {
                var e, f, r, g, h = [], z = d.range.startContainer;
                e = d.range.startPath();
                ...
                "br" != r || !e.data("cke-eol") || k && k != n - 1 || (D = (f = k ? h[k - 1].node : B.getItem(k + 1)) && (!a(f) || !f.is("br")), f = f && a(f) && v.$block[f.getName()]), -1 != L || g || (L = k), g || (q = k), h.push({
                    isElement: 1,
                    isLineBreak: D,
                    ...
                    name: r,
                    allowed: g
                }), f = D = 0)) : h.push({isElement: 0, node: e, allowed: 1});
            ...
            function d(b, c) {
                var e = [], f = b.getChildren(), r = f.count(), g, h = 0, z = v[c], k = !b.is(v.$inline) || b.is("br");
            ...
            var v = CKEDITOR.dtd, B = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1, ul: 1, ol: 1, li: 1, pre: 1, dl: 1, blockquote: 1}, L = {p: 1, div: 1, h1: 1, h2: 1, h3: 1, h4: 1, h5: 1, h6: 1}, n = CKEDITOR.tools.extend({},
                v.$inline);
            delete n.br;
            return function (B, p, F, t) {
                ...
                if (!t.checkReadOnly()) {
                    ...
                    if (!p.collapsed) {
                        var G = q.block || q.blockLimit, x = p.getCommonAncestor();
                    ...
                    if (m = F) {
                        ...
                        if ((C = m.startPath().block) && (1 != C.getChildCount() || !C.getBogus())) a:{
                            ...
                            if (1 ==
                                ...
                                m = 0;
                                for (t = C.count(); m < t; m++) if (p = C.getItem(m), !p.is(n)) break a;
                    ...
                    if (m) {
                        ...
                        var H, K;
                        p = A.startContainer;
                        var N = B.endPath.elements[0], W, q = N.getPosition(p), x = !!N.getCommonAncestor(p) && q != CKEDITOR.POSITION_IDENTICAL && !(q & CKEDITOR.POSITION_CONTAINS + CKEDITOR.POSITION_IS_CONTAINED);
                        p = b(B.dataWrapper, B);
                        for (g(p, A); t < p.length; t++) {
                            ...
                            if (M = q.isLineBreak) {
                                ...
                                q.hasBlockSibling ? M = 1 : (R = M.startContainer.getAscendant(v.$block, 1)) && R.is({
                                    div: 1,
                                    p: 1
                                }) ? (Y = R.getPosition(H), Y == CKEDITOR.POSITION_IDENTICAL || Y == CKEDITOR.POSITION_CONTAINS ? M = 0 : (H = M.splitElement(R), M.moveToPosition(H, CKEDITOR.POSITION_AFTER_START), M = 1)) : M = 0
                            }
                            if (M) F = 0 < t; else {
                                M = A.startPath();
                                ...
                                if (G && q.isElement) {
                                    ...
                                    if (M) H && (K = A.splitElement(H), B.zombies.push(K), B.zombies.push(H)); else {
                                        H = w.getName();
                                        W = !t;
                                        M = t == p.length - 1;
                                        H = d(q.node, H);
                    ...
                    if (K) for (; E = K.pop();) CKEDITOR.env.needsBrFiller ? E.appendBogus() : E.append(y.document.createText(" "));
            ...
            return {
                list: {
                    detectMerge: function (a, b) {
                        var d = c(b, a.bookmark), e = d.startPath(), f = d.endPath(), g = e.contains(CKEDITOR.dtd.$list), h = f.contains(CKEDITOR.dtd.$list);
                    ...
                    function a(c) {
                        var e =
                            [], f, g = new CKEDITOR.dom.walker(c), h = c.startPath().contains(d), k = c.endPath().contains(d), p = {};
                    ...
                    return {
                        detectPurge: function (a) {
                            ...
                            var g = c(f, e.bookmark), h = g.clone(), k, l, p = g.getCommonAncestor();
    ...
    (function () {
        ...
        function e() {
            ...
            if (b) {
                ...
                if (!(d = !c) && (d = !c.isHidden())) {
                    d = b;
                    var e = c.getRanges(), f = d.getRanges(), g = e.length && e[0]._getTableElement() && e[0]._getTableElement().getAscendant("table",
                        !0), h = f.length && f[0]._getTableElement() && f[0]._getTableElement().getAscendant("table", !0), p = 1 === e.length && e[0]._getTableElement() && e[0]._getTableElement().is("table"), k = 1 === f.length && f[0]._getTableElement() && f[0]._getTableElement().is("table"),
        ...
        function f(a, b) {
            ...
            if (c) {
                if (!1 !== b) {
                    var d = a.getDocument().getSelection().getNative(), e = d && "None" != d.type && d.getRangeAt(0), f = K.length;
        ...
        CKEDITOR.on("instanceCreated", function (a) {
            ...
            c.on("contentDom", function () {
                ...
                var h = c.document, p = CKEDITOR.document, k = c.editable(), t =
                    h.getBody(), l = h.getDocumentElement(), r = k.isInline(), z, q;
        ...
        CKEDITOR.dom.selection.prototype = {
            getNative: function () {
                ...
                var a = x ? function () {
                    ...
                    var b = function (b, c) {
                        ...
                        for (var e = d.children, f, g, h = b.duplicate(), k = 0,
                                 l = e.length - 1, r = -1, q, n; k <= l;) if (r = Math.floor((k + l) / 2), f = e[r], h.moveToElementText(f), q = h.compareEndPoints("StartToStart", b), 0 < q) l = r - 1; else if (0 > q) k = r + 1; else return {container: d, offset: a(f)};
                ...
                var b = this, c = CKEDITOR.tools.tryThese(function () {
                    ...
                    function () {
                        for (var a = b.getRanges()[0].clone(), c, d, e = 2; e && !((c = a.getEnclosedNode()) && c.type == CKEDITOR.NODE_ELEMENT && D[c.getName()] && (d = c)); e--) a.shrink(CKEDITOR.SHRINK_ELEMENT);
                        return d && d.$
                    });
                        ...
                        if (x) {
                            ...
                            for (m = 0; m < b.length; m++) {
                                ...
                                try {
                                    ...
                                    if (0 <= u.toString().indexOf("NS_ERROR_ILLEGAL_VALUE")) d.collapse(1), G.setEnd(d.endContainer.$, d.endOffset); else throw u;
                                }
                                k.addRange(G)
                            }
                        }
    ...
    (function () {
            ...
            if (c.collapsed) f = K(this, f), c.insertNode(f), c.moveToPosition(f, CKEDITOR.POSITION_BEFORE_END); else {
                ...
                for (r.getPosition(u) == CKEDITOR.POSITION_FOLLOWING && (r = 0); r;) {
                    ...
                    if (r.equals(u)) r = null, l = !0; else {
                        ...
                        if (x && m && CKEDITOR.dtd.$block[A]) for (var y = r, z = e(y), D = void 0, H = z.length, I = 0, y = H && new CKEDITOR.dom.range(y.getDocument()); I < H; ++I) {
                            var D = z[I], J = CKEDITOR.filter.instances[D.data("cke-filter")];
                            if (J ? J.check(this) : 1) y.selectNodeContents(D), b.call(this, y)
                        }
                        z = A ? !q[A] || C ? 0 : x && !m ? 0 : d(r, u, h, V) : 1;
                        if (z) if (D = r.getParent(), z = h, H = g, I = k, !D || !(D.getDtd() || CKEDITOR.dtd.span)[H] && !I || z.parentRule && !z.parentRule(D)) l = !0; else {
                            if (v ||
        ...
        function A(a, b) {
            ...
            for (g in d) if ("class" != g && !this._.definition.fullMatch || a.getAttribute(g) == u(g, d[g])) b && "data-" == g.slice(0, 5) || (f = a.hasAttribute(g), a.removeAttribute(g));
        ...
        }, z = /\s*(?:;\s*|$)/, v = /#\((.+?)\)/g, B = CKEDITOR.dom.walker.bookmark(0, 1), L = CKEDITOR.dom.walker.whitespaces(1);
        ...
        CKEDITOR.style.prototype = {
            apply: function (a) {
                ...
                if (a instanceof
                    CKEDITOR.dom.document) return J.call(this, a.getSelection(), 1);
                if (this.checkApplicable(a.elementPath(), a)) {
                    var b = this._.enterMode;
                    b || (this._.enterMode = a.activeEnterMode);
                ...
                if ("string" == typeof this.element ?
                    ...
                    if (c._length) {
                        for (var h in c) if ("_length" != h) if (d = a.getAttribute(h) || "", "style" == h ? I(c[h], d) : c[h] == d) {
                            if (!b) return !0
                        } else if (b) return !1;
                        if (b) return !0
                    } else return !0
        ...
        attachStyleStateChange: function (a, d) {
            ...
            b || (b = this._.styleStateChangeCallbacks = [], this.on("selectionChange", function (a) {
                for (var d = 0; d < b.length; d++) {
                    var g = b[d], h = g.style.checkActive(a.data.path, this) ? CKEDITOR.TRISTATE_ON : CKEDITOR.TRISTATE_OFF;
                    g.fn.call(this, h)
                }
            }));
            b.push({style: a, fn: d})
    ...
    (function () {
        function a(a, c, d) {
            var g = a.serializable, h = c[d ? "endContainer" : "startContainer"], k = d ? "endOffset" : "startOffset", n = g ? c.document.getById(a.startNode) : a.startNode;
...
*/
            ...
            CKEDITOR.tools.extend(CKEDITOR.ui.dialog, {
                labeledElement: function (b, a, d, f) {
                    ...
                    if (!(3 > arguments.length)) {
                        h.call(this, a);
                        var f = this._.inputId = CKEDITOR.tools.getNextId() + "_textInput", c = {"class": "cke_dialog_ui_input_" + a.type, id: f, type: a.type};
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.uiElement.call(this, b, a, d, "span", null, null, function () {
                            var c = CKEDITOR.tools.extend({}, a, {id: a.id ? a.id + "_checkbox" : CKEDITOR.tools.getNextId() + "_checkbox"}, !0), e = [], d = CKEDITOR.tools.getNextId() + "_label", g = {"class": "cke_dialog_ui_checkbox_input", type: "checkbox", "aria-labelledby": d};
                            t(c);
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this,
                            b, a, d, function () {
                                for (var e = [], d = [], g = (a.id ? a.id : CKEDITOR.tools.getNextId()) + "_radio", k = 0; k < a.items.length; k++) {
                                    var l = a.items[k], h = void 0 !== l[2] ? l[2] : l[0], n = void 0 !== l[1] ? l[1] : l[0], p = CKEDITOR.tools.getNextId() + "_radio_input", q = p + "_label", p = CKEDITOR.tools.extend({}, a, {id: p, title: null, type: null}, !0),
                                        h = CKEDITOR.tools.extend({}, p, {title: h}, !0), r = {type: "radio", "class": "cke_dialog_ui_radio_input", name: g, value: n, "aria-labelledby": q}, u = [];
                    ...
                    if (!(3 > arguments.length)) {
                        ...
                        CKEDITOR.ui.dialog.labeledElement.call(this, b, a, d, function () {
                            var c = CKEDITOR.tools.extend({}, a, {id: a.id ? a.id + "_select" : CKEDITOR.tools.getNextId() + "_select"}, !0), e = [], d = [], g = {id: f.inputId, "class": "cke_dialog_ui_input_select", "aria-labelledby": this._.labelId};
    ...
    (function () {
        ...
        CKEDITOR.dialog.prototype = {
            destroy: function () {
                ...
                return function (a, b) {
                    ...
                    a && this._.contentSize.height == b || (CKEDITOR.dialog.fire("resize", {dialog: this, width: a, height: b}, this._.editor), this.fire("resize", {width: a, height: b}, this._.editor), this.parts.contents.setStyles({
                        width: a + "px",
                        height: b + "px"
                    }), "rtl" == this._.editor.lang.dir && this._.position && (this._.position.x = CKEDITOR.document.getWindow().getViewPaneSize().width - this._.contentSize.width - parseInt(this._.element.getFirst().getStyle("right"), 10)), this._.contentSize = {width: a, height: b})
                }
            }(), getSize: function () {
        ...
        var aa = {resizable: CKEDITOR.DIALOG_RESIZE_BOTH, minWidth: 600, minHeight: 400, buttons: [CKEDITOR.dialog.okButton, CKEDITOR.dialog.cancelButton]}, D = function (a, b, c) {
        ...
        CKEDITOR.plugins.add("a11yhelp", {
            ...
            init: function (b) {
                ...
                b.addCommand("a11yHelp", {
                    exec: function () {
                        var a =
                            b.langCode, a = c.availableLangs[a] ? a : c.availableLangs[a.replace(/-.*/, "")] ? a.replace(/-.*/, "") : "en";
    ...
    (function () {
        ...
        CKEDITOR.plugins.add("blockquote", {
            init: function (g) {
                g.blockless || (g.addCommand("blockquote", m), g.ui.addButton && g.ui.addButton("Blockquote", {label: g.lang.blockquote.toolbar, command: "blockquote", toolbar: "blocks,10"}))
            }
        })
    })();
    (function () {
                        ...
                        if (a.config.toolbarCanCollapse && a.elementMode != CKEDITOR.ELEMENT_MODE_INLINE) {
                            ...
                            a.addCommand("toolbarCollapse", {
                                readOnly: 1, exec: function (b) {
                                    var a = b.ui.space("toolbar_collapser"), c = a.getPrevious(), d = b.ui.space("contents"), e = c.getParent(), h = parseInt(d.$.style.height, 10), g = e.$.offsetHeight, f = a.hasClass("cke_toolbox_collapser_min");
    ...
    (function () {
            ...
            function d() {
                return {
                    ...
                    86, exec: function (b, a) {
                        ...
                        var e = this, d = "undefined" !== typeof a.notification ? a.notification : !0, g = a.type, h = CKEDITOR.tools.keystrokeToString(b.lang.common.keyboard, b.getCommandKeystroke(this)), l =
                            "string" === typeof d ? d : b.lang.clipboard.pasteNotification.replace(/%1/, '\x3ckbd aria-label\x3d"' + h.aria + '"\x3e' + h.display + "\x3c/kbd\x3e"), h = "string" === typeof a ? a : a.dataValue;
        ...
        function E(b) {
            ...
            b.on("contentDom", function () {
                ...
                var e = b.editable(), h = CKEDITOR.plugins.clipboard.getDropTarget(b), k = b.ui.space("top"), v = b.ui.space("bottom");
        ...
        CKEDITOR.plugins.add("clipboard", {
            requires: "notification", init: function (b) {
                ...
                if (CKEDITOR.env.gecko) {
                    var d = ["image/png", "image/jpeg", "image/gif"], f;
                    b.on("paste",
                        function (a) {
                ...
                b.on("paste", function (a) {
                    a = a.data;
                    var e = b._.nextPasteType || a.type, d = a.dataValue, f, n = b.config.clipboard_defaultContentType || "html", l = a.dataTransfer.getTransferType(b);
        ...
        CKEDITOR.plugins.clipboard = {
            ...
            mainPasteEvent: CKEDITOR.env.ie && !CKEDITOR.env.edge ? "beforepaste" : "paste", canClipboardApiBeTrusted: function (b, a) {
                ...
                d.fire("unlockSnapshot")
                                                 ...
                                                 a) {
                var c = b.data.$, d = c.clientX, f = c.clientY, g = a.getSelection(!0).getRanges()[0], e = a.createRange();
    ...
    (function () {
        function v(a, b, c, m, h) {
            ...
            var g = f[h];
            g || (g = f[h] = new CKEDITOR.ui.panel(b, m), g.element = c.append(CKEDITOR.dom.element.createFromHtml(g.render(a), b)), g.element.setStyles({display: "none", position: "absolute"}));
            return g
        }
        ...
        CKEDITOR.ui.floatPanel = CKEDITOR.tools.createClass({
            $: function (a, b, c, m) {
                ...
                addBlock: function (a, b) {
                    ...
                    var l = this.element, e = this._.iframe, e = CKEDITOR.env.ie && !CKEDITOR.env.edge ? e : new CKEDITOR.dom.window(e.$.contentWindow), f = l.getDocument(), r = this._.parentElement.getPositionedAncestor(),
                        t = b.getDocumentPosition(f), f = r ? r.getDocumentPosition(f) : {x: 0, y: 0}, q = "rtl" == this._.dir, d = t.x + (m || 0) - f.x, p = t.y + (h || 0) - f.y;
                    ...
                    CKEDITOR.tools.setTimeout(function () {
                        var a = CKEDITOR.tools.bind(function () {
                            ...
                            var b = n.element.getWindow(), a = l.$.getBoundingClientRect(), b = b.getViewPaneSize(), c = a.width || a.right - a.left, e = a.height || a.bottom - a.top, m = q ? a.right : b.width - a.left, h = q ? b.width - a.right : a.left;
    ...
    (function () {
        ...
        CKEDITOR.menu = CKEDITOR.tools.createClass({
            $: function (a, b) {
                ...
                var d = CKEDITOR.tools.extend({}, b.panel, {css: [CKEDITOR.skin.getPath("editor")], level: this._.level - 1, block: {}}), m = d.block.attributes = d.attributes || {};
                !m.role && (m.role = "menu");
                    ...
                    addTarget: function (a, e) {
                        a.on("contextmenu", function (a) {
                            ...
                            if (!e || !c) {
                                ...
                                var b = a.getTarget().getDocument(), d = a.getTarget().getDocument().getDocumentElement(), c = !b.equals(CKEDITOR.document), b = b.getWindow().getScrollPosition(), g = c ? a.$.clientX : a.$.pageX || b.x + a.$.clientX,
    ...
    (function () {
        ...
        var c = c + (' onkeydown\x3d"return CKEDITOR.tools.callFunction({keydownFn},event,this);" onfocus\x3d"return CKEDITOR.tools.callFunction({focusFn},event);" ' + (CKEDITOR.env.ie ? 'onclick\x3d"return false;" onmouseup' : "onclick") + '\x3d"CKEDITOR.tools.callFunction({clickFn},this);return false;"\x3e\x3cspan id\x3d"{id}_text" class\x3d"cke_combo_text cke_combo_inlinelabel"\x3e{label}\x3c/span\x3e\x3cspan class\x3d"cke_combo_open"\x3e\x3cspan class\x3d"cke_combo_arrow"\x3e' +
            (CKEDITOR.env.hc ? "\x26#9660;" : CKEDITOR.env.air ? "\x26nbsp;" : "") + "\x3c/span\x3e\x3c/span\x3e\x3c/a\x3e\x3c/span\x3e"), k = CKEDITOR.addTemplate("combo", c);
        ...
        CKEDITOR.ui.richCombo = CKEDITOR.tools.createClass({
            $: function (a) {
                ...
                renderHtml: function (a) {
                    ...
                    if (!this._.panel) {
                        var b = this._.panelDefinition, c = this._.panelDefinition.block, k = b.parent || CKEDITOR.document.getBody(), h = "cke_combopanel__" + this.name, e = new CKEDITOR.ui.floatPanel(a, k, b), b = e.addListBlock(this.id, c), d = this;
                        e.onShow = function () {
        ...
        CKEDITOR.plugins.add("wysiwygarea", {
            init: function (a) {
                ...
                a.addMode("wysiwyg", function (f) {
                    ...
                    var c = "document.open();" + (CKEDITOR.env.ie ? "(" + CKEDITOR.tools.fixDomain + ")();" : "") + "document.close();", c = CKEDITOR.env.air ? "javascript:void(0)" : CKEDITOR.env.ie && !CKEDITOR.env.edge ? "javascript:void(function(){" + encodeURIComponent(c) + "}())" : "",
                ...
                function f(d) {
                    ...
                    this.jobs[this.isIndent ? 10 : 30] = {
                        refresh: this.isIndent ? function (d, c) {
                            var f = this.getContext(c), b = CKEDITOR.plugins.indentList.firstItemInPath(this.context, c, f);
    ...
    (function () {
        ...
        var t = /^javascript:/, u = /^mailto:([^?]+)(?:\?(.+))?$/,
            v = /subject=([^;?:@&=$,\/]*)/i, w = /body=([^;?:@&=$,\/]*)/i, x = /^#(.*)$/, y = /^((?:http|https|ftp|news):\/\/)?(.*)$/, z = /^(_(?:self|top|parent|blank))$/, A = /^javascript:void\(location\.href='mailto:'\+String\.fromCharCode\(([^)]+)\)(?:\+'(.*)')?\)$/,
            B = /^javascript:([^(]+)\(([^)]+)\)$/, C = /\s*window.open\(\s*this\.href\s*,\s*(?:'([^']*)'|null)\s*,\s*'([^']*)'\s*\)\s*;\s*return\s*false;*\s*/, D = /(?:^|,)([^=]+)=(\d+|yes|no)/gi, m = {
        ...
        CKEDITOR.plugins.link = {
            getSelectedLink: function (c, b) {
                ...
                var a = b && (b.data("cke-saved-href") || b.getAttribute("href")) || "", d = c.plugins.link.compiledProtectionFunction, f = c.config.emailProtection, e, g = {};
                ...
                if (b) {
                    if (a = b.getAttribute("target")) g.target = {type: a.match(z) ? a : "frame", name: a}; else if (a = (a = b.data("cke-pa-onclick") || b.getAttribute("onclick")) && a.match(C)) for (g.target = {
                        type: "popup",
                        name: a[1]
                    }; f = D.exec(a[2]);) "yes" != f[2] && "1" != f[2] || f[1] in {height: 1, width: 1, top: 1, left: 1} ? isFinite(f[2]) && (g.target[f[1]] = f[2]) : g.target[f[1]] = !0;
                ...
                switch (b.type) {
                    case "url":
                        var a = b.url && void 0 !== b.url.protocol ? b.url.protocol : "http://", f = b.url && CKEDITOR.tools.trim(b.url.url) || "";
                ...
                var a = {img: 1, table: 1, tbody: 1, thead: 1, tfoot: 1, input: 1, select: 1, textarea: 1}, d = b.getSelection();
        ...
        CKEDITOR.unlinkCommand.prototype = {
            exec: function (c) {
                if (CKEDITOR.env.ie) {
                    var b = c.getSelection().getRanges()[0], a = b.getPreviousEditableNode() && b.getPreviousEditableNode().getAscendant("a", !0) || b.getNextEditableNode() && b.getNextEditableNode().getAscendant("a", !0), d;
        ...
        CKEDITOR.removeAnchorCommand.prototype = {
            exec: function (c) {
                ...
                if (b && (d = b.getSelectedElement()) &&
                    (d.getChildCount() ? d.is("a") : CKEDITOR.plugins.link.tryRestoreFakeAnchor(c, d))) d.remove(1); else if (d = CKEDITOR.plugins.link.getSelectedLink(c)) d.hasAttribute("href") ? (d.removeAttributes({name: 1, "data-cke-saved-name": 1}), d.removeClass("cke_anchor")) : d.remove(1);
                b.selectBookmarks(a)
    ...
    (function () {
        ...
        var v = {ol: 1, ul: 1}, K = CKEDITOR.dom.walker.whitespaces(), H = CKEDITOR.dom.walker.bookmark(), u = function (b) {
            return !(K(b) || H(b))
        ...
        CKEDITOR.plugins.add("list", {
            requires: "indentlist", init: function (b) {
                ...
                (b.ui.addButton("NumberedList", {label: b.lang.list.numberedlist, command: "numberedlist", directional: !0, toolbar: "list,10"}), b.ui.addButton("BulletedList", {
    ...
    (function () {
            ...
            init: function (a) {
                ...
                a.on("contentDom", function () {
                    ...
                    d.is(B.$inline) || (b.inInlineMode && !ba(d) && d.setStyles({position: "relative", top: null, left: null}), la.call(this, b), N(b), d.attachListener(a, "beforeUndoImage",
                        ...
                        var c, d, e, f;
                        for (f in{p: 1, br: 1, div: 1}) for (c = a.document.getElementsByTag(f), e = c.count(); e--;) if ((d = c.getItem(e)).data("cke-magicline-hot")) {
                            b.hotNode = d;
        ...
        var v = CKEDITOR.tools.extend, R = CKEDITOR.dom.element, G = R.createFromHtml, t = CKEDITOR.env, ja = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, B = CKEDITOR.dtd, K = {}, I = 128, da = 64, T = 32, M = 16, C = 4, D = 2, x = 1, J = " ", fa = B.$listItem, oa = B.$tableContent,
            ma = v({}, B.$nonEditable, B.$empty), Z = B.$block, ga = 100, Q = "width:0px;height:0px;padding:0px;margin:0px;display:block;z-index:9999;color:#fff;position:absolute;font-size: 0px;line-height:0px;",
    ...
    (function () {
        var f = {
            canUndo: !1, async: !0, exec: function (a, b) {
                var c = a.lang, e = CKEDITOR.tools.keystrokeToString(c.common.keyboard, a.getCommandKeystroke(CKEDITOR.env.ie ? a.commands.paste : this)), d = b && "undefined" !== typeof b.notification ? b.notification : !b || !b.from || "keystrokeHandler" === b.from && CKEDITOR.env.ie,
        ...
        CKEDITOR.plugins.add("pastefromword", {
            requires: "clipboard", init: function (a) {
                ...
                a.on("paste", function (d) {
                    var b = d.data, g = (CKEDITOR.plugins.clipboard.isCustomDataTypesSupported ? b.dataTransfer.getData("text/html", !0) : null) || b.dataValue, e = {dataValue: g}, h = /(class=\"?Mso|style=(?:\"|\')[^\"]*?\bmso\-|w:WordDocument|<o:\w+>|<\/font>)/,
    ...
    CKEDITOR.plugins.add("scayt", {
        requires: "menubutton,dialog", tabToOpen: null, dialogName: "scaytDialog", onLoad: function (a) {
            ...
            a.ui.add("Scayt", CKEDITOR.UI_MENUBUTTON, {
                label: b.text_title, title: a.plugins.wsc ? a.lang.wsc.title : b.text_title, modes: {wysiwyg: !(e.ie && (8 > e.version || e.quirks))}, toolbar: "spellchecker,20", refresh: function () {
            ...
            if (a.config.scayt_disableOptionsStorage) {
                var c = CKEDITOR.tools.isArray(a.config.scayt_disableOptionsStorage) ? a.config.scayt_disableOptionsStorage : "string" === typeof a.config.scayt_disableOptionsStorage ? [a.config.scayt_disableOptionsStorage] : void 0,
                    e = "all options lang ignore-all-caps-words ignore-domain-names ignore-words-with-mixed-cases ignore-words-with-numbers".split(" "), f = ["lang", "ignore-all-caps-words", "ignore-domain-names", "ignore-words-with-mixed-cases",
            ...
            return {
                scayt: {
                    ...
                    grayt_problemdescription: {
                        label: "Grammar problem description", group: "grayt_description", order: 1, state: CKEDITOR.TRISTATE_DISABLED, exec: function (a) {
                        }
                    }, grayt_ignore: {
            ...
            if (0 < c.length && "no_any_suggestions" !== c[0]) if (d) for (d = 0; d < c.length; d++) {
                ...
                d < a.config.scayt_maxSuggestions ? (a.addMenuItem(k, {label: c[d], command: k, group: "scayt_suggest", order: d + 1}), b[k] = CKEDITOR.TRISTATE_OFF) : (a.addMenuItem(k, {
                    ...
                    label: h.getLocal("btn_moreSuggestions"), group: "scayt_moresuggest", order: 10, getItems: function () {
                        return e
                    }
            ...
            }), a.addMenuItem("no_scayt_suggest", {label: h.getLocal("btn_noSuggestions") || "no_scayt_suggest", command: "no_scayt_suggest", group: "scayt_suggest", order: 0});
            return b
    ...
    CKEDITOR.plugins.scayt = {
        charsToObserve: [{
        ...
        }], onLoadTimestamp: "", state: {scayt: {}, grayt: {}}, warningCounter: 0, suggestions: [], options: {
            ...
            this.loadScaytLibrary(a, function (a) {
                ...
                if (f) {
                    ...
                    g.subscribe("selectionIsChanged", function (c) {
            ...
            if (!a.blockless) {
                ...
                a.addCommand("table", new CKEDITOR.dialogCommand("table", {
                    context: "table", allowedContent: "table{width,height}[align,border,cellpadding,cellspacing,summary];caption tbody thead tfoot;th td tr[scope];" + (a.plugins.dialogadvtab ?
                        ...
                        element: "table", right: function (b) {
    ...
    (function () {
        function q(d, e) {
            ...
            function c(b) {
                0 < a.length || b.type != CKEDITOR.NODE_ELEMENT || !H.test(b.getName()) || b.getCustomData("selected_cell") || (CKEDITOR.dom.element.setMarker(g, b, "selected_cell", !0), a.push(b))
            }

            if (d) {
                for (var f = d.getRanges(), a = [], g = {}, h = 0; h < f.length; h++) {
                    var k = f[h];
                    if (k.collapsed) (k = k.getCommonAncestor().getAscendant({td: 1, th: 1}, !0)) && b(k) && a.push(k); else {
                        var k = new CKEDITOR.dom.walker(k), l;
                        for (k.guard = c; l = k.next();) l.type ==
        ...
        function t(d, e) {
            for (var b = G(d) ? d : q(d), c = b[0], f = c.getAscendant("table"), c = c.getDocument(), a = b[0].getParent(), g = a.$.rowIndex, b = b[b.length - 1], h = b.getParent().$.rowIndex + b.$.rowSpan - 1, b = new CKEDITOR.dom.element(f.$.rows[h]), g = e ? g : h, a = e ? a : b, b = CKEDITOR.tools.buildTableMap(f),
                     f = b[g], g = e ? b[g - 1] : b[g + 1], b = b[0].length, c = c.createElement("tr"), h = 0; f[h] && h < b; h++) {
                var k;
                1 < f[h].rowSpan && g && f[h] == g[h] ? (k = f[h], k.rowSpan += 1) : (k = (new CKEDITOR.dom.element(f[h])).clone(), k.removeAttribute("rowSpan"), k.appendBogus(), c.append(k), k = k.$);
                h += k.colSpan - 1
            }
        ...
        function D(d) {
            if (d instanceof CKEDITOR.dom.selection) {
                ...
                d.reset();
                for (d = a; d <= g; d++) {
                    for (var h = f[d], k = new CKEDITOR.dom.element(c.$.rows[d]), l = 0; l < h.length; l++) {
                        var r = new CKEDITOR.dom.element(h[l]), n = r.getParent().$.rowIndex;
                ...
                a = new CKEDITOR.dom.element(f[g + 1] || (0 < a ? f[a - 1] : null) || c.$.parentNode);
        ...
        function p(d, e) {
            for (var b = G(d) ? d : q(d), c = b[0].getAscendant("table"), f = w(b, 1), b =
                w(b), a = e ? f : b, g = CKEDITOR.tools.buildTableMap(c), c = [], f = [], b = g.length, h = 0; h < b; h++) c.push(g[h][a]), f.push(e ? g[h][a - 1] : g[h][a + 1]);
            for (h = 0; h < b; h++) c[h] && (1 < c[h].colSpan && f[h] == c[h] ? (g = c[h], g.colSpan += 1) : (a = new CKEDITOR.dom.element(c[h]), g = a.clone(), g.removeAttribute("colSpan"), g.appendBogus(), g[e ? "insertBefore" : "insertAfter"].call(g, a), g = g.$), h += g.rowSpan - 1)
        }
        ...
        function v(d) {
            if (d instanceof CKEDITOR.dom.selection) {
                ...
                a:{
                    var a = 0;
                    f = b.length - 1;
                    for (var g = {}, h, k; h = b[a++];) CKEDITOR.dom.element.setMarker(g, h, "delete_cell", !0);
                    for (a = 0; h = b[a++];) if ((k = h.getPrevious()) && !k.getCustomData("delete_cell") || (k = h.getNext()) && !k.getCustomData("delete_cell")) {
                        CKEDITOR.dom.element.clearAllMarkers(g);
                        f = k;
                        break a
                    }
                    CKEDITOR.dom.element.clearAllMarkers(g);
                    a = b[0].getParent();
                    (a = a.getPrevious()) ? f = a.getLast() : (a = b[f].getParent(),
        ...
        function x(d, e) {
            ...
            b["moveToElementEdit" + (e ? "End" : "Start")](d) || (b.selectNodeContents(d), b.collapse(e ?
                !1 : !0));
            b.select(!0)
        }
        ...
        function z(d, e, b) {
            ...
            var g = CKEDITOR.tools.buildTableMap(f), h = g.length, k = g[0].length, l = d.getParent().$.rowIndex, r = y(g, l, d);
            if (e) {
                var n;
                try {
                    var C =
                        parseInt(d.getAttribute("rowspan"), 10) || 1;
                    a = parseInt(d.getAttribute("colspan"), 10) || 1;
                    n = g["up" == e ? l - C : "down" == e ? l + C : l]["left" == e ? r - a : "right" == e ? r + a : r]
                } catch (x) {
                    return !1
                }
                if (!n || d.$ == n) return !1;
            ...
            for (e = 0; e < c.length; e++) {
                a = c[e];
                var p = a.getParent(), w = a.getFirst(), m = a.$.colSpan, v = a.$.rowSpan, p = p.$.rowIndex, z = y(g, p, a), t = t + m * v, C = Math.max(C, z - r + m);
                n = Math.max(n, p -
                    l + v);
            ...
            c = b.count();
            for (e = c - 1; 0 <= e; e--) f = b.getItem(e),
            f.$.cells.length || (f.remove(), c++);
            return d
        }
        ...
        function A(d, e) {
            ...
            if (e) return !0;
            var b = b[0], c = b.getParent(), f = c.getAscendant("table"), a = CKEDITOR.tools.buildTableMap(f), g = c.$.rowIndex, h = y(a, g, b), k = b.$.rowSpan, l;
            if (1 < k) {
                l = Math.ceil(k / 2);
                for (var k = Math.floor(k / 2), c = g + l, f = new CKEDITOR.dom.element(f.$.rows[c]), a = y(a, c), r, c = b.clone(), g = 0; g < a.length; g++) if (r = a[g], r.parentNode == f.$ && g > h) {
                    c.insertBefore(new CKEDITOR.dom.element(r));
                    break
                } else r = null;
                r || f.append(c)
            } else for (k = l = 1,
                            f = c.clone(), f.insertAfter(c), f.append(c = b.clone()), r = y(a, g), h = 0; h < r.length; h++) r[h].rowSpan++;
            c.appendBogus();
            b.$.rowSpan = l;
            c.$.rowSpan = k;
        ...
        function F(d, e) {
            ...
            if (1 < b.length) return !1;
            if (e) return !0;
            var b = b[0], c = b.getParent(), f = c.getAscendant("table"), f = CKEDITOR.tools.buildTableMap(f), a = y(f, c.$.rowIndex, b), g = b.$.colSpan;
            ...
            requires: "table,dialog,contextmenu", init: function (d) {
                ...
                b("cellProperties", new CKEDITOR.dialogCommand("cellProperties", e({
                    allowedContent: "td th{width,height,border-color,background-color,white-space,vertical-align,text-align}[colspan,rowspan]", requiredContent: "table", contentTransformations: [[{
                        ...
                        element: "td",
                        check: "td{height}", left: function (a) {
                ...
                b("columnDelete", e({
                    requiredContent: "table", exec: function (a) {
                        var b = a.getSelection();
                        a = b.getRanges();
                        var c = q(b), d = c[0], e = c[c.length - 1], c = d.getAscendant("table"), f = CKEDITOR.tools.buildTableMap(c), n, p, t = [];
                        b.reset();
                        for (var m = 0, b = f.length; m < b; m++) for (var u = 0, v = f[m].length; u < v; u++) f[m][u] == d.$ && (n = u), f[m][u] == e.$ && (p = u);
                        for (m = n; m <= p; m++) for (u = 0; u < f.length; u++) e = f[u], d = new CKEDITOR.dom.element(c.$.rows[u]), e = new CKEDITOR.dom.element(e[m]), e.$ && (1 == e.$.colSpan ?
                            e.remove() : --e.$.colSpan, u += e.$.rowSpan - 1, d.$.cells.length || t.push(d));
                ...
                b("cellMerge", e({
                    allowedContent: "td[colspan,rowspan]", requiredContent: "td[colspan,rowspan]", exec: function (a, b) {
                    ...
                    tablecell: {
                        ...
                        group: "tablecell", order: 1, getItems: function () {
                            ...
                            return {
                                ...
                                tablecell_split_vertical: F(a, !0) ? CKEDITOR.TRISTATE_OFF :
                                    CKEDITOR.TRISTATE_DISABLED,
    ...
    (function () {
        function B(a, b) {
            var c = a.getAscendant("table"), d = b.getAscendant("table"), g = CKEDITOR.tools.buildTableMap(c), e = a.getAscendant("tr", !0).$.rowIndex, f = b.getAscendant("tr", !0).$.rowIndex, n = [], r = {}, p, l;
            c.contains(d) && (b = b.getAscendant({td: 1, th: 1}), f = b.getAscendant("tr", !0).$.rowIndex);
            e > f && (c = e, e = f, f = c, c = a, a = b, b = c);
            for (c = 0; c < g[e].length; c++) if (a.$ === g[e][c]) {
                p = c;
                break
            }
            for (c = 0; c < g[f].length; c++) if (b.$ === g[f][c]) {
                l = c;
                break
            }
            p > l && (c = p, p = l, l = c);
            for (c = e; c <= f; c++) for (e = p; e <= l; e++) d = new CKEDITOR.dom.element(g[c][e]),
            d.$ && !d.getCustomData("selected_cell") && (n.push(d), CKEDITOR.dom.element.setMarker(r, d, "selected_cell", !0));
        ...
        function C(a, b) {
            ...
            a.fire("unlockSnapshot");
            b && (h = {active: !1}, a.getSelection().isInTable() && a.getSelection().reset())
        }

        function x(a, b) {
            var c = [], d, g;
            for (g = 0; g < b.length; g++) d = a.createRange(), d.setStartBefore(b[g]), d.setEndAfter(b[g]), c.push(d);
        ...
        function L(a, b, c) {
            ...
            b = b.is("table") ? null : b;
            var g;
            (g = h.active && !h.first) && !(g = b) && (g = a.getSelection().getRanges(), g = 1 < d.length || g[0] && !g[0].collapsed ? !0 : !1);
            if (g) h.first = b || d[0], h.dirty = b ? !1 : 1 !== d.length; else if (h.active && b && h.first.getAscendant("table").equals(b.getAscendant("table"))) {
                d = B(h.first, b);
        ...
        function M(a) {
            var b = (a = a.editor || a.sender.editor) &&
                a.getSelection(), c = b && b.getRanges() || [], d;
            if (b && (C(a), b.isInTable() && b.isFake)) {
                ...
                0 < d.length && (a.editable().addClass("cke_table-faked-selection-editor"), d[0].getAscendant("table").addClass("cke_table-faked-selection-table"));
                a.fire("unlockSnapshot")
            }
        }
        ...
        function y(a) {
            function b(a, b) {
                return a && b ? a.equals(b) ||
                    a.contains(b) || b.contains(a) || a.getCommonAncestor(b).is(p) : !1
            }
            ...
            function d(a, d, e, g) {
                return "mousedown" === a.name && (D(a) || !g) || "mouseup" === a.name && !c(a.data.getTarget()) && !b(e, g) ? !0 : !1
            }

            if (a.data.getTarget().getName) {
                var g = a.editor || a.listenerData.editor, e = g.getSelection(1), f = J(g), n = a.data.getTarget(), r = n && n.getAscendant({td: 1, th: 1}, !0), n = n && n.getAscendant("table", !0), p = {table: 1, thead: 1, tbody: 1, tfoot: 1, tr: 1, td: 1, th: 1};
                d(a,
                    e, f, n) && C(g, !0);
                !h.active && "mousedown" === a.name && D(a) && n && (h = {active: !0}, CKEDITOR.document.on("mouseup", y, null, {editor: g}));
                (r || n) && L(g, r || n, a);
                "mouseup" === a.name && (D(a) && (c(a.data.getTarget()) || b(f, n)) && K(g), h = {active: !1}, CKEDITOR.document.removeListener("mouseup", y))
            }
        }
        ...
        function O(a, b) {
            ...
            var d = a.getSelection(), g = d.createBookmarks(),
                e = a.document, f = a.createRange(), n = e.getDocumentElement().$, r = CKEDITOR.env.ie && 9 > CKEDITOR.env.version, p = a.blockless || CKEDITOR.env.ie ? "span" : "div", l, m, z, q;
            e.getById("cke_table_copybin") || (l = e.createElement(p), m = e.createElement(p), m.setAttributes({id: "cke_table_copybin", "data-cke-temp": "1"}), l.setStyles({
                position: "absolute",
                width: "1px",
                height: "1px",
                overflow: "hidden"
            }), l.setStyle("ltr" == a.config.contentsLangDirection ? "left" : "right", "-5000px"), l.setHtml(a.getSelectedHtml(!0)), a.fire("lockSnapshot"), m.append(l),
                a.editable().append(m), q = a.on("selectionChange", c, null, null, 0), r && (z = n.scrollTop), f.selectNodeContents(l), f.select(), r && (n.scrollTop = z), setTimeout(function () {
                m.remove();
                d.selectBookmarks(g);
                q.removeListener();
                a.fire("unlockSnapshot");
        ...
        function P(a) {
            ...
            function d(a) {
                var b = a.getAscendant("table"), d = a.getParent().$.rowIndex, b = CKEDITOR.tools.buildTableMap(b), c;
                for (c = 0; c < b[d].length; c++) if ((new CKEDITOR.dom.element(b[d][c])).equals(a)) return c
            }

            var g = a.editor, e = g.dataProcessor, f = g.getSelection(), n = new CKEDITOR.dom.element("body"), r = 0, p = 0, l = 0, m = 0, z = {}, q, k, h, u, w, v;
            e || (e = new CKEDITOR.htmlDataProcessor(g));
            n.setHtml(e.toHtml(a.data.dataValue), {fixForBody: !1});
            m = n.findOne("table");
            if (f.getRanges().length && (f.isInTable() || (q = b(f))) && (k = t(f), k.length)) {
                a.stop();
                a = k[0].getAscendant("table");
                k = t(f, a);
                h = k[0];
                l = h.getParent();
                u = k[k.length - 1];
                w = u.getParent();
                if (!q) for (e = 0; e < k.length; e++) k[e].setHtml("");
                if (1 < n.getChildCount() || !m) k[0].setHtml(n.getHtml()), g.fire("saveSnapshot"); else {
                    if (q) {
                        k = l.getChildCount();
                        l = w = new CKEDITOR.dom.element("tr");
                        l["insert" + (1 === q ? "Before" : "After")](h.getParent());
                        for (e = 0; e < k; e++) h =
                            new CKEDITOR.dom.element("td"), h.appendTo(l);
                        h = l.getFirst();
                        u = l.getLast();
                        f.selectElement(l);
                        k = t(f)
                    }
                    q = CKEDITOR.tools.buildTableMap(a, l.$.rowIndex, E(h, !0), w.$.rowIndex, d(u));
                    f = CKEDITOR.tools.buildTableMap(m);
                    l = c(f);
                    m = c(q);
                    if (f.length > q.length) for (r = f.length - q.length, e = 0; e < r; e++) H(k);
                    if (l > m) for (p = l - m, e = 0; e < p; e++) I(k);
                    h = k[0];
                    l = h.getParent();
                    u = k[k.length - 1];
                    w = new CKEDITOR.dom.element(a.$.rows[u.getParent().$.rowIndex + r]);
                    u = w.getChild(u.$.cellIndex + p);
                    r = E(k[0], !0);
                    k = d(u);
                    q = CKEDITOR.tools.buildTableMap(a,
                        l.$.rowIndex, r, w.$.rowIndex, k);
                    for (e = 0; e < f.length; e++) for (p = new CKEDITOR.dom.element(a.$.rows[l.$.rowIndex + e]), k = 0; k < f[e].length; k++) if (v = new CKEDITOR.dom.element(f[e][k]), n = q[e] && q[e][k] ? new CKEDITOR.dom.element(q[e][k]) : null, v && !v.getCustomData("processed")) {
                        if (n && n.getParent()) v.replace(n); else if (0 === k || f[e][k - 1]) (n = 0 !== k ? new CKEDITOR.dom.element(f[e][k - 1]) : null) && p.equals(n.getParent()) ? v.insertAfter(n) : 0 < r ? v.insertAfter(new CKEDITOR.dom.element(p.$.cells[r])) : p.append(v, !0);
                        CKEDITOR.dom.element.setMarker(z,
                            v, "processed", !0)
                    } else v.getCustomData("processed") && n && n.remove();
                    CKEDITOR.dom.element.clearAllMarkers(z);
                    x(g, B(new CKEDITOR.dom.element(f[0][0]), v));
                    g.fire("saveSnapshot");
                    setTimeout(function () {
                        g.fire("afterPaste")
                    }, 0)
        ...
        function F(a, b, c) {
            a.on("beforeCommandExec", function (d) {
                -1 !== CKEDITOR.tools.array.indexOf(b, d.data.name) && (d.data.selectedCells = t(a.getSelection()))
            });
            ...
            getCellsBetween: B, keyboardIntegration: function (a) {
                ...
                c.attachListener(c, "keydown", function (a) {
                    function c(b, e) {
                        ...
                        var g = a.createRange(), l = CKEDITOR.dom.range.mergeRanges(e);
                        CKEDITOR.tools.array.forEach(l, function (a) {
                            a.enlarge(CKEDITOR.ENLARGE_ELEMENT)
                        });
                        var m = l[0].getBoundaryNodes(),
                            h = m.startNode, m = m.endNode;
                        if (h && h.is && h.is(f)) {
                            for (var q = h.getAscendant("table", !0), k = h.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q), t = !1, u = function (a) {
                                return !h.contains(a) && a.is && a.is("td", "th")
                            }; k && !u(k);) k = k.getPreviousSourceNode(!1, CKEDITOR.NODE_ELEMENT, q);
                            !k && m && m.is && !m.is("table") && m.getNext() && (k = m.getNext().findOne("td, th"), t = !0);
                            if (k) g["moveToElementEdit" + (t ? "Start" : "End")](k); else g.setStartBefore(h.getAscendant("table", !0)), g.collapse(!0);
                            l[0].deleteContents();
                            return [g]
                        }
                        if (h) return g.moveToElementEditablePosition(h),
                            [g]
                    }

                    var e = {37: 1, 38: 1, 39: 1, 40: 1, 8: 1, 46: 1}, f = CKEDITOR.tools.extend({table: 1}, CKEDITOR.dtd.$tableContent);
                    delete f.td;
                    delete f.th;
                    return function (f) {
                        var h = f.data.getKey(), p, l = 37 === h || 38 == h, m, t, q;
                        if (e[h] && (p = a.getSelection()) && p.isInTable() && p.isFake) if (m = p.getRanges(), t = m[0]._getTableElement(), q = m[m.length - 1]._getTableElement(), f.data.preventDefault(), f.cancel(), 8 < h && 46 > h) m[0].moveToElementEditablePosition(l ? t : q, !l), p.selectRanges([m[0]]); else {
                            for (f = 0; f < m.length; f++) b(m[f]);
                            (f = c(t, m)) ? m = f : m[0].moveToElementEditablePosition(t);
                            p.selectRanges(m);
                            a.fire("saveSnapshot")
                        }
                    }
                ...
                c.attachListener(c, "keypress", function (d) {
                    var c = a.getSelection(), e = d.data.$.charCode || 13 === d.data.getKey(), f;
                    if (c && c.isInTable() && c.isFake && e && !(d.data.getKeystroke() & CKEDITOR.CTRL)) {
                        d = c.getRanges();
                        e = d[0].getEnclosedNode().getAscendant({td: 1, th: 1}, !0);
                        for (f = 0; f < d.length; f++) b(d[f]);
                        d[0].moveToElementEditablePosition(e);
                        c.selectRanges([d[0]])
                    }
                }, null, null, -1)
        ...
        CKEDITOR.plugins.add("tableselection",
            {
                requires: "clipboard,tabletools", onLoad: function () {
                    ...
                    CKEDITOR.plugins.tableselection.isSupportedEnvironment && (a.addContentsCss && a.addContentsCss(this.path + "/styles/tableselection.css"), a.on("contentDom", function () {
                        ...
                        b.attachListener(c, "mousedown", y, null,
                            d);
                        ...
                        CKEDITOR.plugins.clipboard && !CKEDITOR.plugins.clipboard.isCustomCopyCutSupported && (b.attachListener(b, "cut", G), b.attachListener(b, "copy", G))
                    }), a.on("paste", P), F(a, "rowInsertBefore rowInsertAfter columnInsertBefore columnInsertAfter cellInsertBefore cellInsertAfter".split(" "), function (a, c) {
                        x(a,
                            c.selectedCells)
                    }), F(a, ["cellMerge", "cellMergeRight", "cellMergeDown"], function (a, c) {
