...
CKEDITOR.dialog.add('image2', function (editor) {
	...
	var regexGetSizeOrEmpty = /(^\s*(\d+)(px)?\s*$)|^$/i,
		...
		marginTopField, marginBottomField, marginLeftField, marginRightField, 
		...
		contents: [
			{
				...
				elements: [
                    ...
                    {
                        type: 'html',
                        html: "<div style='margin-bottom:-10px'><b>Margini</b></div>"
                    },
                    {
                        type: 'hbox',
                        label: 'Margini',
						...
						children: [
							{
								...
								commit: function (widget) {
									...
									console.log("align:", this.getValue());
								}
							}
						]
					},
