...
(function () {
            ...
            init: function () {
                var helpers = CKEDITOR.plugins.image2,
                    ...
                    data = {
                        ...
                        marginLeft: parseInt(image.getStyle('marginLeft')) || '',
                        marginTop: parseInt(image.getStyle('marginTop')) || '',
                        marginRight: parseInt(image.getStyle('marginRight')) || '',
                        marginBottom: parseInt(image.getStyle('marginBottom')) || '',
    ...
    function setMargins(widget) {
        var data = widget.data,
            margins = {marginTop: data.marginTop, marginBottom: data.marginBottom, marginLeft: data.marginLeft, marginRight: data.marginRight},
            image = widget.parts.image;

        for (var m in margins) {
            image.setStyle(m, (margins[m] || 0) + "px");
        }
    }
    ...
    function getWidgetFeatures(editor) {
        var alignClasses = editor.config.image2_alignClasses,
            features = {
                ...
                margins: {
                    requiredContent: 'img[marginTop,marginBottom,marginLeft,marginRight]'
                },
                caption: {
