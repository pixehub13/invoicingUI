(function () {
	...
	function LoginController($scope, authService, dataStore, $timeout) {
		...
		// you can fill with a default user name and pass, in production this line will not be available (see email.js version)
		vm.loginInfo = {email: "bogdanim36@gmail.com", "parola": "test"};
		vm.ctrl = {
			login: function () {
