...
var moduleTexts = function () {
	var texts = {
		...
		VatRegistred: {en: "Vat Registred", ro: "Platitor TVA"},
		VatRegistration: {en: "Vat CODE", ro: "C.I.F."},
		IdentityCard:{en:"Identity Card", ro:"Carte De Identitate"},
		...
		SecurityNumber: {en: "Security Number", ro: "C.N.P."},
